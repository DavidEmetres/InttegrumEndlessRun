...
//	private float nextGenerationTime;
	...
	private void Awake() {
		...
		Province castellon = new Province ("Castellón", Climate.Playa);
		Province valencia = new Province ("Valencia", Climate.Playa);
		Province alicante = new Province ("Alicante", Climate.Playa);
		//CATALUÑA;
		Province tarragona = new Province ("Tarragona", Climate.Playa);
		Province barcelona = new Province ("Barcelona", Climate.Playa);
		Province gerona = new Province ("Gerona", Climate.Playa);
		Province lerida = new Province ("Lérida", Climate.Regadio);
		//ARAGÓN;
		Province huesca = new Province ("Huesca", Climate.Secano);
		Province zaragoza = new Province ("Zaragoza", Climate.Secano);
		Province teruel = new Province ("Teruel", Climate.Secano);
		//NAVARRA;
		Province navarra = new Province ("Navarra", Climate.Ganadero);
		//PAIS VASCO;
		Province guipuzcoa = new Province ("Guipúzcoa", Climate.Ganadero);
		Province vizcaya = new Province ("Vizcaya", Climate.Ganadero);
		Province alava = new Province ("Álava", Climate.Ganadero);
		//LA RIOJA;
		Province larioja = new Province ("La Rioja", Climate.Secano);
		//CANTABRIA;
		Province cantabria = new Province ("Cantabria", Climate.Ganadero);
		//ASTURIAS;
		Province asturias = new Province ("Asturias", Climate.Ganadero);
		//GALICIA;
		Province lacoruna = new Province ("La Coruña", Climate.Ganadero);
		Province lugo = new Province ("Lugo", Climate.Ganadero);
		Province pontevedra = new Province ("Pontevedra", Climate.Ganadero);
		Province ourense = new Province ("Ourense", Climate.Ganadero);
		//CASTILLA Y LEÓN;
		Province leon = new Province ("León", Climate.Secano);
		Province palencia = new Province ("Palencia", Climate.Secano);
		Province burgos = new Province ("Burgos", Climate.Secano);
		Province soria = new Province ("Soria", Climate.Secano);
		Province segovia = new Province ("Segovia", Climate.Secano);
		Province valladolid = new Province ("Valladolid", Climate.Secano);
		Province zamora = new Province ("Zamora", Climate.Secano);
		Province salamanca = new Province ("Salamanca", Climate.Secano);
		Province avila = new Province ("Ávila", Climate.Secano);
		//MADRID;
		Province madrid = new Province ("Madrid", Climate.Secano);
		//CASTILLA LA MANCHA;
		Province guadalajara = new Province ("Guadalajara", Climate.Secano);
		Province cuenca = new Province ("Cuenca", Climate.Secano);
		Province toledo = new Province ("Toledo", Climate.Secano);
		Province ciudadreal = new Province ("Ciudad Real", Climate.Secano);
		Province albacete = new Province ("Albacete", Climate.Secano);
		//EXTREMADURA;
		Province caceres = new Province ("Cáceres", Climate.Regadio);
		Province badajoz = new Province ("Badajoz", Climate.Regadio);
		//ANDALUCÍA;
		Province huelva = new Province ("Huelva", Climate.Playa);
		Province sevilla = new Province ("Sevilla", Climate.Regadio);
		Province cadiz = new Province ("Cádiz", Climate.Playa);
		Province cordoba = new Province ("Córdoba", Climate.Regadio);
		Province malaga = new Province ("Málaga", Climate.Playa);
		Province jaen = new Province ("Jaén", Climate.Regadio);
		Province granada = new Province ("Granada", Climate.Regadio);
		Province almeria = new Province ("Almería", Climate.Playa);
		//MURCIA;
		Province murcia = new Province ("Murcia", Climate.Playa);
