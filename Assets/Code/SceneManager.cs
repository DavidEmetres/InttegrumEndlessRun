...
//	private float nextGenerationTime;
	...
	private void Awake() {
		...
		Province lerida = new Province ("Lérida", Climate.Mediterranean);
		//ARAGÓN;
		...
		//EXTREMADURA;
		Province caceres = new Province ("Cáceres", Climate.Mediterranean);
		Province badajoz = new Province ("Badajoz", Climate.Mediterranean);
		//ANDALUCÍA;
		Province huelva = new Province ("Huelva", Climate.Mediterranean);
		Province sevilla = new Province ("Sevilla", Climate.Mediterranean);
		Province cadiz = new Province ("Cádiz", Climate.Mediterranean);
		Province cordoba = new Province ("Córdoba", Climate.Mediterranean);
		Province malaga = new Province ("Málaga", Climate.Mediterranean);
		Province jaen = new Province ("Jaén", Climate.Mediterranean);
